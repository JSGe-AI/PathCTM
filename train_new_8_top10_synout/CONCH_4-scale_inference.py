...
from models.ctm_inference_conch_top10_synout import ContinuousThoughtMachine
...
def parse_args():
    ...
    parser.add_argument('--device', type=int, nargs='+', default=[0], help='List of GPU(s) to use.')
    parser.add_argument('--use_amp', action=argparse.BooleanOptionalAction, default=False, help='AMP autocast.')
    
    parser.add_argument('--num_class', type=int, default=7, help='Num workers training.')
    parser.add_argument('--threshold', type=float, default=1, help='threshold 0.5, 0.75, 0.9....')
...
class CustomDataset(Dataset):
    def __init__(self, txt_file, device='cuda'):
        ...
        self.scale_dirs = {
            '0_1024': os.path.join(root_part, '0_1024/all_class'),
