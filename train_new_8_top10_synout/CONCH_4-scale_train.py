...
from models.ctm_top10_synout import ContinuousThoughtMachine
...
def parse_args():
    ...
    # Model Architecture
    parser.add_argument('--d_model', type=int, default=4096, help='Dimension of the model.')
    parser.add_argument('--dropout', type=float, default=0.05, help='Dropout rate.')
    parser.add_argument('--backbone_type', type=str, default='resnet18-4', help='Type of backbone featureiser.')
    parser.add_argument('--d_input', type=int, default=1024, help='Dimension of the input (CTM, LSTM).')
    parser.add_argument('--heads', type=int, default=16, help='Number of attention heads (CTM, LSTM).')
    parser.add_argument('--iterations', type=int, default=80, help='Number of internal ticks (CTM, LSTM).')
    ...
    parser.add_argument('--synapse_depth', type=int, default=12, help='Depth of U-NET model for synapse. 1=linear, no unet (CTM only).')
    parser.add_argument('--n_synch_out', type=int, default=150, help='Number of neurons to use for output synch (CTM only).')
    parser.add_argument('--n_synch_action', type=int, default=150, help='Number of neurons to use for observation/action synch (CTM only).')
    parser.add_argument('--neuron_select_type', type=str, default='random', help='Protocol for selecting neuron subset (CTM only).')
    ...
    parser.add_argument('--memory_length', type=int, default=30, help='Length of the pre-activation history for NLMS (CTM only).')
    parser.add_argument('--deep_memory', action=argparse.BooleanOptionalAction, default=True, help='Use deep memory (CTM only).')
    parser.add_argument('--memory_hidden_dims', type=int, default=64, help='Hidden dimensions of the memory if using deep memory (CTM only).')
    ...
    parser.add_argument('--lr', type=float, default=5e-5, help='Learning rate for the model.')
    parser.add_argument('--training_iterations', type=int, default=43600, help='Number of training iterations.')
    parser.add_argument('--warmup_steps', type=int, default=4360, help='Number of warmup steps.')
    ...
    parser.add_argument('--weight_decay_exclusion_list', type=str, nargs='+', default=[], help='List to exclude from weight decay.')
    ...
    parser.add_argument('--save_every', type=int, default=436, help='Save checkpoints every this many iterations.')
    ...
    parser.add_argument('--track_every', type=int, default=436, help='Track metrics every this many iterations.')
    parser.add_argument('--n_test_batches', type=int, default=20, help='How many minibatches to approx metrics.')
    
    parser.add_argument('--device', type=int, nargs='+', default=[7], help='List of GPU(s) to use.')
    parser.add_argument('--use_amp', action=argparse.BooleanOptionalAction, default=False, help='AMP autocast.')
    

    parser.add_argument('--fold', type=int, default=4, help='Fold number for cross-validation.')
    
    parser.add_argument('--num_class', type=int, default=3, help='Num workers training.')
