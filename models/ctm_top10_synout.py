    ...
    def forward(self, x, indexs, relations, device, lazy=False, track=False):
        ...
        for stepi in range(self.iterations):
            ...
            if stepi == 0:
                ...
                index_1 = torch.argmax(certainties[..., 1, :20], dim=-1)
                ...
                k = min(topk, att_weight_tensor.size(-1))
                ...
                kv = kv_4096[:, active_indices_4096.long(), :]
                ...
                kv = kv_2048[:, active_indices_2048.long(), :]
                ...
                kv = kv_1024[:, active_indices_1024.long(), :]
